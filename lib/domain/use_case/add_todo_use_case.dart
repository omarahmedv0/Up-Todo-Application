...
class AddTodoUseCase extends BaseUseCase<AddTodoRequestBody, TodoModel> {
  Repository repository;
  AddTodoUseCase({required this.repository});

  @override
  Future<Either<ApiErrorModel, TodoModel>> execute(
      AddTodoRequestBody addTodoRequestBody) async {
    return await repository.addTodo(addTodoRequestBody);
  }
}
